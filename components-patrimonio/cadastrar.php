...
// Verifique se existem departamentos cadastrados
$verificaDepartamentos = "SELECT * FROM departamento";
$resultadoDepartamentos = mysqli_query($con, $verificaDepartamentos);

if (mysqli_num_rows($resultadoDepartamentos) === 0) {
    $message = "Erro: Nenhum departamento cadastrado! Cadastre um departamento primeiro.";
} else {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $departamentoExistente = "SELECT * FROM departamento WHERE nome = '$departamento'";
        $resultadoDepartamento = mysqli_query($con, $departamentoExistente);

        if (mysqli_num_rows($resultadoDepartamento) == 0) {
            $message = "Erro: O departamento '$departamento' não está cadastrado!";
        } else {
...
<div class="main-content-patrimonio">
    <div id="section-cadastrar" class="content-section">
        ...
        <div class="form-content">
            ...
            <?php if (mysqli_num_rows($resultadoDepartamentos) > 0): ?>
